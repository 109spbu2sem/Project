...
class ParallelLines :public IConstraint
{
	double *_p1x, *_p1y, *_p2x, *_p2y, *_p3x, *_p3y, *_p4x, *_p4y;
public:
	ParallelLines(double *p1x, double *p1y, double *p2x, double *p2y, double *p3x, double *p3y, double *p4x, double *p4y)
	{
		_p1x = p1x;
		_p1y = p1y;
		_p2x = p2x;
